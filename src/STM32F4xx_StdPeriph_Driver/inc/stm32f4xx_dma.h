...
#undef  IS_DMA_PERIPHERAL_INC_STATE
...
#undef  IS_DMA_PERIPHERAL_DATA_SIZE
...
void DMA_Init(DMA_Stream_TypeDef* DMAy_Streamx, SDR_DMA_InitTypeDef* DMA_InitStruct);
void DMA_StructInit(SDR_DMA_InitTypeDef* DMA_InitStruct);
