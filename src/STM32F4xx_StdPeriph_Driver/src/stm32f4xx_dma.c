...
/**
  ...
  * @param  DMAy_Streamx: where y can be 1 or 2 to select the DMA and x can be 0
  *         to 7 to select the DMA Stream.
  * @param  DMA_InitStruct: pointer to a SDR_DMA_InitTypeDef structure that contains
...
/**
  ...
  * @param  DMA_InitStruct : pointer to a SDR_DMA_InitTypeDef structure which will 
  *         be initialized.
  * @retval None
  */
